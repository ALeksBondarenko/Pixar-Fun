...
struct MovieDetailRepositoryImplTests {
    ...
    func testGetDetailsOfMovieDelegatesToService() async {
        ...
        let repository = MovieDetailRepositoryImpl(service: service)
    ...
    @Test
    func testGetMovieStatusDelegatesToService() async {
        let service = MockMovieDetailsService()
    ...
    func testAddToFavoritesUsesServiceAndReturnsSuccess() async {
        ...
        do {
            let result = try await repository.addToFavorites(accountId: 100, movieId: 5)
    ...
    func testRemoveFromFavoritesUsesServiceAndReturnsSuccess() async {
        ...
        do {
            let result = try await repository.removeToFavorites(accountId: 200, movieId: 7)
    ...
    func testAddToWatchLaterUsesServiceAndReturnsSuccess() async {
        ...
        do {
            let result = try await repository.addToWatchLater(accountId: 300, movieId: 9)
    ...
    func testRemoveFromWatchLaterUsesServiceAndReturnsSuccess() async {
        ...
        do {
            let result = try await repository.removeToWatchLater(accountId: 400, movieId: 11)
